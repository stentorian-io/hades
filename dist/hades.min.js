    ...
    (function (e) {
        ...
        function (e, t, n) {
            ...
            var w = (function (e) {
                ...
                function l() {
                    return f(this, l), u.apply(this, arguments);
                }
                return (
                    (r = l),
                    (o = [
            ...
            var m = (function () {
                function e(t, n) {
                    ...
                    var r = this._getTableInstanceOrNull();
                    if (null === r)
                        throw new w(
                    ...
                    var o,
                        i =
                            null !== (o = r._rows[this._modelId]) &&
                            void 0 !== o
                                ? o
                                : null;
                    if (null === i)
                        throw new w(
                            "No data exists for Model instance with ID '".concat(
                                n,
                                "'."
                            )
                        );
                ...
                return (
                    ...
                    (n = [
                        ...
                        {
                            key: "_getTableInstanceOrNull",
                            value: function () {
                                var e;
                                return (
                                    (null == this
                                        ? void 0
                                        : this._session.getState()[
                                              null !== (e = this._tableKey) &&
                                              void 0 !== e
                                                  ? e
                                                  : ""
                                          ]) || null
                    ...
                    (n = [
                        {
                            ...
                            value: function (e, t) {
                                var n = this.getDefinedIdentifierFieldNameOrNull(),
                                    r = n || "id";
                                if (e[r]);
                                else if (t && n)
                                    throw new w(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = Object.entries(this._schemaDefinition),
                                    t = e.findIndex(function (e) {
                                        var t = M(e, 2),
                                            n = (t[0], t[1]);
                                        return (
                                            n instanceof u &&
                                            n.equals(O.IDENTIFIER())
                                        );
                                    });
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                return this._keyIdentifierOrNull
                                    ? this._keyIdentifierOrNull.toString()
                                    : "id";
                            },
                        },
                        {
                        ...
                        },
                        {
                            key: "insertRow",
                            value: function (e) {
                                var t = this.getIdentifierKey();
                                if (
                                    this._keyIdentifierOrNull &&
                                    "undefined" ===
                                        C(e[this._keyIdentifierOrNull])
                                )
                                    throw new w(
                                        [
                                            "Cannot insert Table row with missing value for",
                                            "defined identifier '".concat(
                                                this._keyIdentifierOrNull,
                                                "'."
                                            ),
                                        ].join(" ")
                                ...
                                var n = function () {
                                    return e[t] ? e[t] : this._getNextId();
                                }.call(this);
                                if (this._rows[n])
                                    throw new w(
                                        "Cannot insert new Table row since given ID '".concat(
                                            n,
                                            "' is not unique."
                                        )
                                    );
                                if (
                                    ...
                                    e[t]
                                        ...
                                        : (this._meta.lastIdIncremental = r);
                                }
                            },
                        },
                        {
                        ...
                        {
                            key: "_getModelIdentifierFieldNameOrNull",
                            value: function (e) {
                                return e
                                    .fields()
            ...
            function L(e) {
                ...
                return (L = function (e) {
                    ...
                    function r() {
                        return V(e, arguments, H(this).constructor);
                    }
                    return (
                        (r.prototype = Object.create(e.prototype, {
                            constructor: {
            ...
            var J = (function (e) {
                ...
                function l() {
                    return x(this, l), u.apply(this, arguments);
                }
                return (
                    (r = l),
                    (o = [
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                ...
                                var o = e.getModelIdOrNull(),
                                    i = e.getWillApplyToEntireTable(),
                                    u = this._getModelFieldsConvertedForMutationOrNull(
                                        n,
                                        e.getFieldsOrNull(),
                                        t.equals(a.INSERT())
                                    );
                                if (t.equals(a.INSERT()))
                                    this._applyInsertMutation(r, u);
                                else if (t.equals(a.UPSERT()))
                                    this._applyUpsertMutation(r, u);
                                else if (t.equals(a.DELETE()))
                                    this._applyDeleteMutation(r, o, i);
                                else {
                                    if (!t.equals(a.UPDATE()))
                                        throw new J(
                                    ...
                                    this._applyUpdateMutation(r, u, o);
                                }
                            },
                        },
                        {
                            key: "_getModelFieldsConvertedForMutationOrNull",
                            value: function (e, t, n) {
                                if (t) {
                                    var r = e.fields();
                                    return (
                                        r.assertSchemaAllowsFieldsForMutation(
                                            e,
                                            t
                                        ),
                                        r.castValuesAgainstDefinition(t, n)
                                    );
                                }
                                return null;
                            },
                ...
                return (
                    ...
                    (n = [
                        ...
                        },
                        {
                            key: "_registerModels",
                            value: function (e) {
                                this._registeredModels = e.reduce(
                                    function (e, t) {
                                        return (
                                            e.includes(t)
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                var t = new z(e);
                                return (
                                    t.addModels(this._registeredModels),
                                    this._registeredModels.forEach(function (
                                        e
                                    ) {
                                        e.addSession(t);
                                    }),
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                e.getModels().forEach(function (t) {
                                    var n,
                                        r,
                                        o,
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                e.getModels().forEach(function (e) {
                                    "function" === G(e.reducer) && e.reducer(t);
                                });
                            },
                        },
                        {
